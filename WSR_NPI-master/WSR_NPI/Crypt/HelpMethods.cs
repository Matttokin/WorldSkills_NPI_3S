...
namespace WSR_NPI.Crypt
{
    public class HelpMethods
    {
        ...
        public HelpMethods()
        {
            this.Key = Convert.FromBase64String(Cfg.GetKey());
            this.IV = Convert.FromBase64String(Cfg.GetIV());
        }
    public string Encrypt(string plainText)
    {
        ...
        {
            return "Произошла ошибка при шифровании данных";
        }
    }
    public string Decrypt(string plainText)
    {
        ...
        {
            return "Произошла ошибка при расшифровке данных";
        }
    }
